...
namespace UniGif
{
    public static partial class UniGif
    {
        ...
        private struct GifData
        {
            ...
            public void Dump()
            {
                LogManager.Debug("GIF Type: " + signature + "-" + version);
                LogManager.Debug("Image Size: " + m_logicalScreenWidth + "x" + m_logicalScreenHeight);
                LogManager.Debug("Animation Image Count: " + m_imageBlockList.Count);
                LogManager.Debug("Animation Loop Count (0 is infinite): " + m_appEx.loopCount);
                ...
                LogManager.Debug("Application Identifier: " + m_appEx.applicationIdentifier);
                LogManager.Debug("Application Authentication Code: " + m_appEx.applicationAuthenticationCode);
            }
        }
